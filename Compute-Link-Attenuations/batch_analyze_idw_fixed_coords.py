...
def write_excel_report(
    ...
    If additional row lists are provided, writes:
      ...
      - CoverageStats_IDWvsSOL, DistanceStats_IDWvsSOL
    """
    cov_headers = [
        "patch_key",
        "mask_type",
    ...
    if coverage_rows_idw_sol:
        sheets["CoverageStats_IDWvsSOL"] = (coverage_rows_idw_sol, cov_headers, ("rainy",))
    if distance_rows_idw_sol:
        sheets["DistanceStats_IDWvsSOL"] = (distance_rows_idw_sol, dist_headers, ("rainy",))
