...
import MapPanel from "./MapPanel"; // use your current version (stub or real)
...
export default function App() {
  ...
  // active patch (for map + image + highlight)
  const [selectedPatchId, setSelectedPatchId] = useState(null);
  // patches marked for export / reload
  ...
  const handleImportPatchIds = (ids) => {
    ...
    const validIds = ids.filter((id) => patches.some((p) => p.id === id));
    setSelectedPatchIds(validIds);
  };
