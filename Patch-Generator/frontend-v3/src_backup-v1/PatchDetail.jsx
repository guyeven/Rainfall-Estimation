...
export default function PatchDetail({ patch, imageUrl, loading }) {
  ...
  const hasStats = patch && patch.stats;
          ...
          >
            ...
            <div>
              ...
              {patch.width_km && patch.height_km
                ? `${formatKm(patch.width_km)} × ${formatKm(
                    patch.height_km
                  )}`
                : "-"}
            </div>
            ...
            <div style={{ marginTop: "4px" }}>
              ...
              {hasStats ? (
                ...
                >
                  <li>Max rainfall: {formatMm(patch.stats.max_mm)}</li>
                  <li>Average rainfall: {formatMm(patch.stats.mean_mm)}</li>
                </ul>
              ) : (
                "-"
              )}
